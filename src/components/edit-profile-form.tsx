...
export function EditProfileForm({ defaults }: { defaults: Defaults }) {
  ...
  return (
    <form onSubmit={save} className="space-y-4 rounded-2xl border border-black/8 bg-ink-900/60 p-7">
      ...
      <label className="block">
        ...
        <textarea
          ...
          className="w-full rounded-xl border border-black/10 bg-ink-900 p-4 text-sm text-bone-100 outline-none focus:border-ember-500/50"
        />
      </label>
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="h-11 w-full rounded-xl border border-black/10 bg-ink-900 px-4 text-sm text-bone-100 outline-none focus:border-ember-500/50"
      />
    </label>
  );
}
