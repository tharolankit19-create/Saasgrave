    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-[92vw] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-line bg-sunken p-7 shadow-2xl focus:outline-none">
          <Dialog.Title className="font-serif text-2xl text-ink">Verify your revenue</Dialog.Title>
          <Dialog.Description className="mt-1 text-sm text-ink-faint">
            Paste a Stripe <span className="text-ink-soft">restricted, read-only</span> key. We compute
          ...
          <input
            ...
            className="mt-5 h-11 w-full rounded-xl border border-line bg-card px-4 font-mono text-sm text-ink outline-none focus:border-accent-500/50"
          />
