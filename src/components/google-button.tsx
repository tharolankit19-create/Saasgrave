...
// One shared Google entry point, used on the landing page and both auth pages.
// Sign-up friction is the whole problem this redesign is solving, so the fastest
// path — one click, no password — is a first-class button everywhere it helps.
